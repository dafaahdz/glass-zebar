# Agent Guidelines & Safeguards Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Codify a master `agents.md` guidelines file in the project root to enforce pure buildless React constraints, Webview2 performance optimizations, premium glassmorphism visuals, and rigid step-by-step widget addition checklists.

**Architecture:** A comprehensive reference document (`agents.md`) containing explicit constraints, performance safety nets, aesthetic specs, and a structured walkthrough checklist.

**Tech Stack:** Markdown / Developer & Agent Guidelines

---

### Task 1: Create agents.md Guidelines File

**Files:**
- Create: `c:\Users\aipus\.glzr\zebar\glass-pack\agents.md`

- [ ] **Step 1: Write the agents.md file content**

Write the complete guidelines content directly to the project root:
...
Check if the `agents.md` exists and is formatted correctly.

Run:
`Get-Content -Path "c:\Users\aipus\.glzr\zebar\glass-pack\agents.md" -Head 15`

Expected output:
The first 15 lines of the `agents.md` guidelines file showing properly.

- [ ] **Step 3: Commit the implementation**

```bash
git add c:\Users\aipus\.glzr\zebar\glass-pack\agents.md
git commit -m "docs: create agents.md development guidelines and safeguards"
```
